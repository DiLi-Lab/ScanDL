...
class TransformerNetModel(nn.Module):
    """
    The ScanDL transformer for the ablation case without positional embeddings and BERT embeddings
    """
    ...
    def forward(
        ...
        # input to transformer: noised input + timestep embedding (without other two embeddings)
        emb_inputs = x + emb_t.unsqueeze(1).expand(-1, x.size(1), -1)
